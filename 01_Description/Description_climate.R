...
ggplot(d_climate) + 
  geom_line(data = d_climate, linewidth = 0.05, alpha = .25,
            aes(x = Year, y = tas_yearlymeam, col = Scenario, group = interaction(Lon, Lat))) +
...
ggplot(d_climate) + 
  geom_line(data = d_climate, linewidth = 0.05, alpha = .25,
            aes(x = Year, y = tas_yearlymin, col = Scenario, group = interaction(Lon,Lat))) +
  geom_smooth(data = d_climate_mean, aes(x = Year, y = mean_tas_min, group = Scenario), 
              method = "loess", se = FALSE, linewidth = 2.5, color = "black", show.legend = FALSE) +
...
ggplot(d_climate) + 
  geom_line(data = d_climate, linewidth = 0.05, alpha = .25,
            aes(x = Year, y = tas_yearlymax, col = Scenario, group = interaction(Lon,Lat))) +
