...
########################### MFPCA calculation ##############################
#
# Here is a collection of functions published by Clara Happ: 
# https://github.com/ClaraHapp/MFPCA/blob/master/R/MFPCA_calculation.R
# I took her functions and added small changes so that they fit to the MFPCA 
...
#' }
#' par(oldPar)
MFPCA2 <- function(mFData, M, uniExpansions, weights = rep(1, length(mFData)), fit = FALSE, approx.eigen = FALSE,
