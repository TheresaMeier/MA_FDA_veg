...
# num_disturbances = 4
# data_reg_control = get_data_regeneration('picontrol', 'cmass',2015, 2050, num_disturbances)
# data_reg_ssp126 = get_data_regeneration('ssp126', 'cmass', 2015, 2050, num_disturbances)

# data_reg_control1 = get_data_regeneration('picontrol', 'cmass',2015, 2050, 1)
# data_reg_control2 = get_data_regeneration('picontrol', 'cmass',2015, 2050, 2)
# data_reg_control3 = get_data_regeneration('picontrol', 'cmass',2015, 2050, 3)
# data_reg_control4 = get_data_regeneration('picontrol', 'cmass',2015, 2050, 4)
# data_reg_control5 = get_data_regeneration('picontrol', 'cmass',2015, 2050, 5)
...
# data_reg <- purrr::reduce(list(data_reg_control1, data_reg_control2,data_reg_control3,data_reg_control4), bind_rows)%>%
#   mutate(PFT = long_names_pfts(tolower(PFT))) # make pft names pretty

# data_reg <- purrr::reduce(list(data_reg_control, data_reg_ssp126), bind_rows)%>%
#   mutate(PFT = long_names_pfts(tolower(PFT))) # make pft names pretty

#data_reg <- purrr::reduce(list(data_reg_control, data_reg_ssp126, data_scen_ssp370, data_scen_ssp585), bind_rows)
