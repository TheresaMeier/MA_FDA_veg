...
funData_all = readRDS("Scripts/FPCA/FdObjects/funData_all_1803.rds")

# Get MFPCA results
# MFPCA_all = readRDS("Scripts/FPCA/FdObjects/MFPCA_all_1803.rds")
MFPCA_all = readRDS("Scripts/FPCA/FdObjects/MFPCA_all_1803_noApprox_allEVs_126.rds")

for (iYear in c(5,seq(10,120,by=10),126)){
  assign(paste0("MFPCA_", iYear), readRDS(paste0("Scripts/FPCA/FdObjects/MFPCA_all_1803_noApprox_allEVs_", iYear, ".rds")))
}
